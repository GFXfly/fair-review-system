...
async function main() {
    ...
    for (const item of cases) {
        ...
        if (!exists) {
            ...
            console.log(`Case already exists: ${item.title}`);
            ...
            console.log(`Updated case: ${item.title}`);
        }
    }
}
