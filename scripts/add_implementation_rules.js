...
async function addOrUpdate() {
    ...
    if (existing) {
        // 更新
        const result = await prisma.regulation.update({
        ...
        // 新建
        const result = await prisma.regulation.create({
            data: {
                title: '公平竞争审查条例实施办法',
                content: content,
                level: '部门规章',
    ...
    console.log('标题: 公平竞争审查条例实施办法');
    console.log('内容长度:', content.length, '字符');

    await prisma.$disconnect();
}

addOrUpdate().catch(console.error);
