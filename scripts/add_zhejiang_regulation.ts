...
const content = `# 浙江省招标投标领域公平竞争审查细则
...
　　（一）政策措施的审查程序。起草单位应当在政策措施起草阶段开展公平竞争审查，并作出是否符合公平竞争审查标准的书面审查结论（可参考附件 1）。拟由县级以上人民政府出台或者提请本级人民代表大会及其常务委员会审议的政策措施，起草单位应当开展初审，并将政策措施草案、初审意见等相关材料送市场监督管理部门审查；市场监督管理部门应当根据起草单位提供的材料对政策措施开展公平竞争审查，书面作出审查结论。

　　适用《公平竞争审查条例》第十二条规定的例外情形的，应当根据《公平竞争审查条例实施办法》第二十九条第二款的规定在审查结论中作出说明。开展公平竞争审查，应当依法听取利害关系人关于公平竞争影响的意见。涉及社会公众利益的，应当通过政府部门网站、政务新媒体等便于社会公众知晓的方式听取社会公众意见。听取关于公平竞争影响的意见可以与其他征求意见程序一并进行。需要保密或者有正当理由需要限定知悉范围的政策措施，政策制定机关按照相关法律法规规定处理，并在审查结论中说明。

　　（二）招标文件的审查程序。招标人应当在公开发布招标文件前开展公平竞争审查，并作出书面审查结论（可参考附件 2）。书面审查结论应当作为招标文件附件同步公开发布，接受社会监督。

## 五、工作要求

　　（一）强化机制建设。起草单位、招标人应当建立健全本单位内部公平竞争审查工作机制，明确公平竞争审查负责机构和审查流程，严格按照规定履行招标投标领域公平竞争审查职责。

　　（二）强化数字赋能。充分运用人工智能、大数据等新一代数字技术，建设公平竞争审查智能平台，赋能招标投标领域公平竞争审查。探索将公平竞争审查智能平台与公共资源交易等业务系统对接，实现招标文件发布前的智能分析预警，提升公平竞争审查穿透式监管能力。市场监督管理部门应当适时组织开展招标投标领域公平竞争审查大数据抽查，并按照《浙江省公平竞争审查抽查工作细则》规定落实闭环处置。

　　（三）强化协同治理。建立招标文件示范文本公平竞争审查联合审查机制，相关行业行政主管部门在制定招标文件示范文本前，应当会同市场监管、发展改革等部门进行公平竞争审查联合审查，防止发生行业性系统性风险。组织开展招标投标领域政策措施评估清理， STRICT 执行全省招标投标政策措施目录管理机制，未纳入目录的政策措施不得作为监管依据。

　　（四）强化投诉举报处理。投标人或者其他利害关系人认为招标文件存在排斥、限制潜在投标人不合理条件的，有权依照《中华人民共和国招标投标法》及其实施条例有关规定提出异议和投诉，招标投标行政监督部门、招标人应当按照规定程序处理。任何单位和个人认为政策措施或者招标文件违反公平竞争审查相关规定的，有权向政策制定机关及其上一级机关反映，也可以向市场监督管理部门举报；市场监督管理部门接到举报后，应当按照《浙江省公平竞争审查举报处理工作细则》的规定处理。

　　（五）强化责任追究。起草单位、招标人未进行公平竞争审查或者违反审查标准出台政策措施或者发布招标文件的，市场监督管理部门可以依法进行敦促提醒或者约谈。起草单位、招标人存在《公平竞争审查条例实施办法》第四十五条规定的情形、造成严重不良影响的，市场监管部门可以向有权机关提出对直接负责的主管人员和其他直接责任人员依法追究责任的建议。

　　本细则自 2025 年 12 月 1 日起施行。`;

async function main() {
    const title = '浙江省招标投标领域公平竞争审查细则';
    const category = 'BIDDING';
    const level = '地方规范性文件'; // Provincial/Local Policy
    ...
    try {
        ...
        if (existing) {
            console.log('Regulation already exists. Updating...');
            await prisma.regulation.update({
                ...
                data: {
                    ...
                    category,
                    level,
                    publishDate: '2025-12-01' // Based on "本细则自 2025 年 12 月 1 日起施行"
                }
            });
            ...
            await prisma.regulation.create({
                data: {
                    ...
                    embedding: '' // No embedding needed for direct retrieval by category logic? Or maybe we should generate one? For now, empty is fine as we are adding explicit logic to fetch it.
                }
            });
